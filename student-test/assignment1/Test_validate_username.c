...
void test_validate_my_username()
{
     ...
     */
     ...
     const char* user_name_1;
    char* user_name_2;
    user_name_1 = my_username();
    user_name_2 = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(user_name_1,user_name_2,"test pass");
}
